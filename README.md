# HALO V0 — Render API + Vercel + Google/Microsoft OAuth
...
- `backend/api/` — Node API with real Google Gmail + Microsoft Graph OAuth, sessions, encrypted token storage, real mailbox fetch, ML proxy, and institution intelligence
