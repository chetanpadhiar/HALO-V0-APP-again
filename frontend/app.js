...
function topbar() {
  ...
  const providerLabel = connected ? (APP.user.auth_provider === "google" ? "Google" : "Outlook") : null;
...
function screenConnect() {
  return `<div class="center-wrap">
    ...
    <div class="panel">
      ...
      <button class="btn" data-action="connect" data-provider="microsoft">SIGN IN WITH OUTLOOK</button>
      ${APP.error ? `<div class="note">${esc(APP.error)}</div>` : ""}
