...
function screenInstitutionDashboard() {
  ...
  return `<div class="panel">
    ...
    <div class="panel">
      ...
      <button class="btn primary" data-action="institution-response" style="width:auto;margin-top:10px;">OPEN INCIDENT CENTER</button>
    </div>`;
}
  ...
  return `<button class="btn link" data-action="open-incident-center" style="width:auto;">&lt; BACK TO INCIDENT CENTER</button>
    <div class="panel">
      ...
      <div class="action-grid">
        <button class="action-card" data-action="protect-campus"><span class="action-head"><span class="action-num" aria-hidden="true"></span><span class="action-title">QUARANTINE CAMPAIGN</span><span class="action-arrow">→</span></span><span>Demo workflow only. Prepare containment of related messages.</span></button>
        <button class="action-card" data-action="protect-campus"><span class="action-head"><span class="action-num" aria-hidden="true"></span><span class="action-title">BLOCK CAMPAIGN INDICATORS</span><span class="action-arrow">→</span></span><span>Prepare sender/domain/infrastructure indicators for a security team.</span></button>
        <button class="action-card" data-action="protect-campus"><span class="action-head"><span class="action-num" aria-hidden="true"></span><span class="action-title">NOTIFY AFFECTED STUDENTS</span><span class="action-arrow">→</span></span><span>Prepare a targeted safety notification.</span></button>
        <button class="action-card" data-action="protect-campus"><span class="action-head"><span class="action-num" aria-hidden="true"></span><span class="action-title">ASSIGN TO SECURITY TEAM</span><span class="action-arrow">→</span></span><span>Record ownership of the investigation.</span></button>
        <button class="action-card" data-action="incident-contained"><span class="action-head"><span class="action-num" aria-hidden="true"></span><span class="action-title">MARK AS CONTAINED</span><span class="action-arrow">→</span></span><span>Record that containment work is complete.</span></button>
        <button class="action-card" data-action="incident-resolved"><span class="action-head"><span class="action-num" aria-hidden="true"></span><span class="action-title">MARK AS RESOLVED</span><span class="action-arrow">→</span></span><span>Close after verification.</span></button>
      </div>
...
function actionModalFor(r){if(r.bucket==='high-risk')return showModal('TAKE ACTION',`<p><span class="badge high-risk">HIGH RISK</span></p><h3>${esc(r.subject)}</h3><p>HALO recommends protecting you and notifying your cybersecurity team.</p><div class="action-grid"><button class="action-card" data-action="action-report" data-id="${r.id}"><span class="action-head"><span class="action-num">01</span><span class="action-title">REPORT THREAT</span><span class="action-arrow">→</span></span><span>Prepare an investigation-ready incident with HALO analysis and evidence attached.</span></button><button class="action-card" data-action="action-quarantine"><span class="action-head"><span class="action-num">02</span><span class="action-title">REMOVE FROM INBOX</span><span class="action-arrow">→</span></span><span>Choose quarantine or delete.</span></button><button class="action-card" data-action="action-block" data-id="${r.id}"><span class="action-head"><span class="action-num">03</span><span class="action-title">BLOCK SENDER</span><span class="action-arrow">→</span></span><span>Prevent future messages from this sender.</span></button><button class="action-card" data-action="action-link" data-id="${r.id}"><span class="action-head"><span class="action-num">04</span><span class="action-title">CHECK THE LINK</span><span class="action-arrow">→</span></span><span>Inspect the destination without opening it yourself.</span></button><button class="action-card" data-action="action-related" data-id="${r.id}"><span class="action-head"><span class="action-num">05</span><span class="action-title">CHECK FOR OTHER MESSAGES</span><span class="action-arrow">→</span></span><span>Find similar messages and campaign connections.</span></button><button class="action-card" data-action="action-account"><span class="action-head"><span class="action-num">06</span><span class="action-title">PROTECT ACCOUNT</span><span class="action-arrow">→</span></span><span>If credentials were entered, start account protection.</span></button></div>`);if(r.bucket==='attention')return showModal('TAKE ACTION',`<p><span class="badge attention">NEEDS ATTENTION</span></p><p>HALO found some unusual signals, but cannot confirm that this email is malicious.</p><div class="action-grid"><button class="action-card" data-action="action-review"><span class="action-head"><span class="action-title">REVIEW SAFELY</span><span class="action-arrow">→</span></span><span>Review without opening unknown links or attachments.</span></button><button class="action-card" data-action="action-verify"><span class="action-head"><span class="action-title">VERIFY SENDER</span><span class="action-arrow">→</span></span><span>Confirm through a trusted channel.</span></button><button class="action-card" data-action="action-link" data-id="${r.id}"><span class="action-head"><span class="action-title">INSPECT LINK</span><span class="action-arrow">→</span></span><span>Inspect the destination before opening it.</span></button><button class="action-card" data-action="action-report" data-id="${r.id}"><span class="action-head"><span class="action-title">REPORT FOR REVIEW</span><span class="action-arrow">→</span></span><span>Send the message for human review.</span></button></div>`);return showModal('TAKE ACTION',`<p><span class="badge safe">LOOKS SAFE</span></p><p>HALO found no strong indicators of malicious behaviour.</p><div class="action-grid"><button class="action-card" data-action="action-open"><span class="action-head"><span class="action-title">OPEN EMAIL</span><span class="action-arrow">→</span></span><span>Continue to the message.</span></button><button class="action-card" data-action="action-analysis"><span class="action-head"><span class="action-title">VIEW ANALYSIS</span><span class="action-arrow">→</span></span><span>See how HALO reached this classification.</span></button><button class="action-card" data-action="action-sender"><span class="action-head"><span class="action-title">CHECK SENDER</span><span class="action-arrow">→</span></span><span>Review sender identity, authentication and behaviour.</span></button><button class="action-card" data-action="action-trust"><span class="action-head"><span class="action-title">MARK AS TRUSTED</span><span class="action-arrow">→</span></span><span>Record this sender as trusted in the demo.</span></button></div><p class="note info">Looks Safe does not mean guaranteed safe.</p>`);}
